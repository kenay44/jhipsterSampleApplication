package my.sample.app.web.rest;

import my.sample.app.config.Constants;
import my.sample.app.JhipsterSampleApplicationApp;
import my.sample.app.domain.Authority;
import my.sample.app.domain.User;
import my.sample.app.repository.AuthorityRepository;
import my.sample.app.repository.UserRepository;
import my.sample.app.security.AuthoritiesConstants;
import my.sample.app.service.MailService;
import my.sample.app.service.dto.UserDTO;
import my.sample.app.web.rest.errors.ExceptionTranslator;
import my.sample.app.web.rest.vm.KeyAndPasswordVM;
import my.sample.app.web.rest.vm.ManagedUserVM;
import my.sample.app.service.UserService;
